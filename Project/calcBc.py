...
def getBcSpiral(gx, gy, x,y,z, affine, B0=3):
    ...
    f3 = .5 * (affine[1]*affine[2]+affine[4]*affine[5]) * (affine[6]**2-affine[7]**2) + affine[7] * affine[8] * \
         (2*affine[0]**2 + affine[1]**2 + 2*affine[3]**2 + affine[4]**2) \
    ...
    g_sq = gx**2 + gy**2
    spatial = (f1 * x**2 + f2 * y**2 + f3 * z**2 + f4 * y * z + \
          f5 * x * z + f6 * x * y)
